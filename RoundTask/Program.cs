    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                Console.WriteLine("Сircumference is {0:.##}", r1.Сircumference);
                Console.WriteLine();

                Round r2 = new Round(5);
                r2.Print();
                Console.WriteLine("Round area is {0:.##}", r2.Area);
                Console.WriteLine("Сircumference is {0:.##}", r2.Сircumference);
                Console.WriteLine();

                Round r3 = new Round(3.8, new Point(-8, 9));
                r3.Print();
                Console.WriteLine("Round area is {0:.##}", r3.Area);
                Console.WriteLine("Сircumference is {0:.##}", r3.Сircumference);
                Console.WriteLine();

                Round r4 = new Round(10, -2, 2);
                r4.Print();
                Console.WriteLine("Round area is {0:.##}", r4.Area);
                Console.WriteLine("Сircumference is {0:.##}", r4.Сircumference);
                Console.WriteLine();
